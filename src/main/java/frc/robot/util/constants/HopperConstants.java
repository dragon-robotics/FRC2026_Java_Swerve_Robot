...
public final class HopperConstants {
  ...
  public static final double HOPPER_ROLLER_STATOR_CURRENT_LIMIT = 50.0;
  public static final double HOPPER_ROLLER_SUPPLY_CURRENT_LIMIT = 40.0;
  public static final double HOPPER_ROLLER_SUPPLY_CURRENT_LOWER_LIMIT = 20.0;
  public static final double HOPPER_ROLLER_SUPPLY_CURRENT_LOWER_TIME = 0.2;
