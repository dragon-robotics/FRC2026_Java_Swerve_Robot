...
public final class VisionConstants {
   ...
   * the predicted drivetrain pose at the same timestamp.
   */
   ...
   * multiplier. Kept configurable because some camera layouts observed
   * over-strict behavior when always penalizing coplanar sets.
   */
  ...
  /**
   * Ordered PhotonPoseEstimator strategy chain used by VisionIOPhotonVision.
   * Supported names include: MULTI_TAG_PNP_ON_COPROCESSOR,
   * CONSTRAINED_SOLVEPNP, PNP_DISTANCE_TRIG_SOLVE, LOWEST_AMBIGUITY.
   */
