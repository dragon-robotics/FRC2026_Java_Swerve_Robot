...
public final class VisionConstants {
  ...
  /**
   * Same-loop vision observations within this XY distance (meters) are treated as agreeing on the
  ...
  public static final boolean APPLY_COPLANAR_PENALTY =
      Boolean.parseBoolean(System.getProperty("vision.applyCoplanarPenalty", "true"));

  /**
   * Static PhotonPoseEstimator strategy chain used only when dynamic strategy selection is disabled
   * or {@code vision.photon.strategyOrder} is set. Supported names include:
   * MULTI_TAG_PNP_ON_COPROCESSOR, CONSTRAINED_SOLVEPNP, PNP_DISTANCE_TRIG_SOLVE, LOWEST_AMBIGUITY.
   */
