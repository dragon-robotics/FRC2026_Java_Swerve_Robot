...
public final class VisionConstants {
  ...
  // Reject candidate poses that strongly disagree with another camera's recent
  // accepted pose. This catches camera-specific glitches without disabling
  // useful single-camera updates when peers are unavailable.
  public static final double MAX_CROSS_CAMERA_DISCREPANCY_METERS = 0.75;
  public static final double CROSS_CAMERA_MAX_AGE_SECONDS = 0.3;

  // ── Constrained SolvePnP Hybrid Fallback ───────────────────────────────
  // Coprocessor MultiTag remains primary; constrained solve is only attempted
  // as a controlled fallback when dynamics are favorable.
