...
public final class FieldConstants {
  ...
  public static final class Tower {
    ...
    // ── Blue Alliance ──────────────────────────────────────────────────────
    public static final Translation2d BLUE_CENTER_POINT = new Translation2d(FRONT_FACE_X,
        APTAG_FIELD_LAYOUT.getTagPose(31).get().getY());
    public static final Translation2d BLUE_LEFT_UPRIGHT = new Translation2d(
        FRONT_FACE_X,
        (APTAG_FIELD_LAYOUT.getTagPose(31).get().getY())
            + INNER_OPENING_WIDTH / 2
            + Units.inchesToMeters(0.75));
    public static final Translation2d BLUE_RIGHT_UPRIGHT = new Translation2d(
        FRONT_FACE_X,
        (APTAG_FIELD_LAYOUT.getTagPose(31).get().getY())
            - INNER_OPENING_WIDTH / 2
            - Units.inchesToMeters(0.75));
    ...
    public static final Translation2d RED_LEFT_UPRIGHT = new Translation2d(
        FIELD_LENGTH - FRONT_FACE_X,
        (FIELD_WIDTH - APTAG_FIELD_LAYOUT.getTagPose(31).get().getY())
            + INNER_OPENING_WIDTH / 2
            + Units.inchesToMeters(0.75));
    public static final Translation2d RED_RIGHT_UPRIGHT = new Translation2d(
        FIELD_LENGTH - FRONT_FACE_X,
        (FIELD_WIDTH - APTAG_FIELD_LAYOUT.getTagPose(31).get().getY())
            - INNER_OPENING_WIDTH / 2
            - Units.inchesToMeters(0.75));
  ...
  public static final class Outpost {
    ...
    // ── Blue Alliance ───────────────────────────────────────────────────────
    public static final Translation2d BLUE_CENTER_POINT = new Translation2d(0,
        APTAG_FIELD_LAYOUT.getTagPose(29).get().getY());
