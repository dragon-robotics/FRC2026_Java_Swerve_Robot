...
public final class FieldConstants {
  ...
  public static class AimPoints {
    ...
    public static final Translation2d RED_LEFT_PURGE_POINT =
        new Translation2d(
            RED_NEUTRAL_AIM_X,
            (LinesHorizontal.RED_LEFT_TRENCH_OPEN_START + LinesHorizontal.RED_LEFT_TRENCH_OPEN_END)
                / 2.0);
    public static final Translation2d RED_RIGHT_PURGE_POINT =
        new Translation2d(
            RED_NEUTRAL_AIM_X,
            (LinesHorizontal.RED_RIGHT_TRENCH_OPEN_START
                    + LinesHorizontal.RED_RIGHT_TRENCH_OPEN_END)
                / 2.0);
