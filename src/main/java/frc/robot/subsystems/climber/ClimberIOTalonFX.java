...
public class ClimberIOTalonFX implements ClimberIO {
  ...
  private final MotionMagicExpoTorqueCurrentFOC climberMotionMagicTorqueCurrentFOC;
  ...
  public void setElevatorSetpoint(double setPoint) {
    leadMotor.setControl(climberMotionMagicTorqueCurrentFOC.withPosition(setPoint));
  }
