...
public class IntakeIOSparkMax implements IntakeIO {
    ...
    public IntakeIOSparkMax() {
        ...
        rollerConfig
            ...
            .smartCurrentLimit((int) INTAKE_ROLLER_STATOR_CURRENT_LIMIT, (int) INTAKE_ROLLER_STATOR_CURRENT_LIMIT)
        ...
        armConfig
            .voltageCompensation(INTAKE_ARM_MAX_VOLTAGE)
            .smartCurrentLimit((int) INTAKE_ARM_STATOR_CURRENT_LIMIT, (int) INTAKE_ARM_STATOR_CURRENT_LIMIT)
            .secondaryCurrentLimit(INTAKE_ARM_SUPPLY_CURRENT_LIMIT)
  ...
  public void updateInputs(IntakeIOInputs inputs) {
    ...
    inputs.setIntakeRollerMotorVoltage(intakeRollerMotor.getAppliedOutput() * intakeRollerMotor.getBusVoltage());
    ...
    inputs.setIntakeArmMotorVoltage(intakeArmMotor.getAppliedOutput() * intakeArmMotor.getBusVoltage());
