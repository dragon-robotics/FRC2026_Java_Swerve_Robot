...
public class IntakeIOTalonFXTunable extends IntakeIOTalonFX {
  ...
  public IntakeIOTalonFXTunable(
    ...
    // If motor name contains "Roller", default to velocity control, otherwise default to position
    // control
    ...
    controlRequestType =
        DogLog.tunable(
            ...
            newControlRequestType -> {
              // No need to apply to motor config, since all control requests are always configured.
              // Just update setpoints based on new control type
