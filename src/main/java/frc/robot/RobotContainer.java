...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    driverController.back().and(driverController.y()).whileTrue(swerveSubsystem.sysIdDynamic(Direction.kForward));
    driverController.back().and(driverController.x()).whileTrue(swerveSubsystem.sysIdDynamic(Direction.kReverse));
    driverController.start().and(driverController.y()).whileTrue(swerveSubsystem.sysIdQuasistatic(Direction.kForward));
    driverController.start().and(driverController.x()).whileTrue(swerveSubsystem.sysIdQuasistatic(Direction.kReverse));
